...
const ROLE = [
  ...
  'each folder plus its user/agent classification) — those workers could not see each other, so it is',
  'YOUR job to connect the graph while respecting that structure.',
